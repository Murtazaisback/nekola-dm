    ...
    <Modal isOpen={isOpen} onClose={onClose}>
        <div className="sm:flex sm:items-start">
            ...
            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                <Dialog.Title as="h3" className="text-base font-semibold leading-6 text-gray-600">
                    Delete Conversation
                </Dialog.Title>
                <div className="mt-2">
                    <p className="text-sm text-gray-500">Are you Sure yuo want to delete this Conversaion?</p>
                </div>
            </div>
        </div>
